    ...
    public class PostServiceTest
    {
        ...
        public void GetPosts_Return_Any()
        {
            mockRepository.Setup(mRep => mRep.GetAll())
                ...
                {
                    new Post {Id=0,Title="Post 1",Content="Content1",Tags="Tags"},
                    new Post {Id=1,Title="Post 2",Content="Content2",Tags="Tags"},
                    new Post {Id=2,Title="Post 3",Content="Content3",Tags="Tags"},
                    new Post {Id=3,Title="Post 4",Content="Content4",Tags="Tags"}
                });
        ...
        public void GetPost_ReturnOne()
        {
            mockRepository.Setup(mRep => mRep.Get(0))
                .Returns(new Post
                { Id = 0, Title = "Post 1", Content = "Content1", Tags = "Tags" });
        ...
        {
            var data = new Post { Id = 0, Title = "Post 1", Content = "Content1", Tags = "Tags" };
        ...
        {
            var data = new Post { Id = 4, Title = "Post 1", Content = "Content1", Tags = "Tags" };
            var datas = new List<Post>
                {
                    new Post {Id=0,Title="Post 1",Content="Content1",Tags="Tags"},
                    new Post {Id=1,Title="Post 2",Content="Content2",Tags="Tags"},
